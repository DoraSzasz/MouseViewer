...
public class DatasetListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<String> datasets = getIntent().getExtras()
				.getStringArrayList(
						"com.ovidora.MouseViewer.bundle.DatasetList");
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(
				getBaseContext(), android.R.layout.simple_list_item_1, datasets);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view,
				...
				curIntent.putExtra(
						"com.ovidora.MouseViewer.bundle.DatasetName", value);
				curIntent.putExtra(
						"com.ovidora.MouseViewer.bundle.DatasetOffset", pos);
